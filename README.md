...
Favorite city view: can be reached from the city selector by click in it. In this page you can select a favorite city to watch the weather in that city. If you want to delete a city just swipe it left.
